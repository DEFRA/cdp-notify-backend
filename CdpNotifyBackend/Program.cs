using CdpNotifyBackend.Example.Endpoints;
using CdpNotifyBackend.Example.Services;
using CdpNotifyBackend.Utils;
using CdpNotifyBackend.Utils.Http;
using CdpNotifyBackend.Utils.Mongo;
using FluentValidation;
using System.Diagnostics.CodeAnalysis;
using CdpNotifyBackend.Config;
using CdpNotifyBackend.Utils.Logging;
using Serilog;
